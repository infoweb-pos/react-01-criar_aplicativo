...
4. [Criar o aplicativo Next.js](#4-criar-o-aplicativo-nextjs)
   ...
   - 4.2 [Respondendo as perguntas do `create-next-app`](#42-respondendo-as-perguntas-do-create-next-app)
5. [Executando o projeto](#5-executando-o-projeto)
   - 5.1 [Modo desenvolvimento](#modo-desenvolvimento)
6. [Entendendo o projeto](#6-entendendo-o-projeto)
   - 6.1 [Estrutura de diretórios do projeto](#estrutura-de-diretórios-do-projeto)
   - 6.2 [Descrição dos principais arquivos e diretórios](#descrição-dos-principais-arquivos-e-diretórios)
   - 6.3 [Como o App Router funciona](#como-o-app-router-funciona)
   - 6.4 [Como o alias `@/*` funciona](#como-o-alias--funciona)
   - 6.5 [Modificando a página inicial](#modificando-a-página-inicial)
7. [Publicando o projeto no repositório (push)](#7-publicando-o-projeto-no-repositório-push)
   - 7.1 [Configure o .gitignore](#configure-o-gitignore)
   - 7.2 [Marque e guardar os arquivos no repositório, e publicar no github](#marque-e-guardar-os-arquivos-no-repositório-e-publicar-no-github)
8. [Outras informações](#8-outras-informações)
   - 8.1 [Biome](#biome)
   - 8.2 [React Compiler](#react-compiler)
   - 8.3 [Verificar lint e formatação](#verificar-lint-e-formatação)
   - 8.4 [Build de produção](#build-de-produção)
